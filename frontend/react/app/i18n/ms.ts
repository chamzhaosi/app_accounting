...
export const ms: Record<keyof typeof zhHans, string> = {
  ...
  "Search transactions...": "Cari transaksi...",
  Filters: "Penapis",
  "Dismiss filters": "Tutup penapis",
  "Clear account": "Kosongkan akaun",
  "Clear category": "Kosongkan kategori",
  "Date range": "Julat tarikh",
  "Clear date range": "Kosongkan julat tarikh",
  "Transaction type": "Jenis transaksi",
  "Minimum Amount": "Amaun Minimum",
  "Maximum Amount": "Amaun Maksimum",
  "Min Amount": "Amaun Min",
  "Max Amount": "Amaun Maks",
  ...
  "Remove recent search": "Buang carian terkini",
  "Search Results": "Hasil Carian",
  "Search your transactions": "Cari transaksi anda",
  "Search by description, category, account, or amount.":
    "Cari mengikut penerangan, kategori, akaun atau amaun.",
  "No transactions found": "Tiada transaksi ditemui",
